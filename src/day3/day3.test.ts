...
describe("Day 3", () => {
	...
	describe("Part 1", () => {
		it("returns the correct result for the example input", () => {
			expect(part1(exampleInput)).toEqual(357);
		});

		it("returns the correct result for the real input", () => {
			expect(part1(realInput)).toEqual(17445);
		});
	});

	describe("Part 2", () => {
		it("returns the correct result for the example input", () => {
			expect(part2(exampleInput)).toEqual(3121910778619);
		});

		it("returns the correct result for the real input", () => {
			expect(part2(realInput)).toEqual(173229689350551);
		});
	});
});
