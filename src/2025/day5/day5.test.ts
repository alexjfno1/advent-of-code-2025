...
describe("2025 - Day 1", () => {
	...
	describe("Part 1", () => {
		it("returns the correct result for the example input", () => {
			expect(part1(exampleInput)).toEqual(3);
		});

		it("returns the correct result for the real input", () => {
			expect(part1(realInput)).toEqual(885);
		});
	});

	describe("Part 2", () => {
		it("returns the correct result for the example input", () => {
			expect(part2(exampleInput)).toEqual(14);
		});

		it("returns the correct result for the real input", () => {
			expect(part2(realInput)).toEqual(348115621205535);
		});
	});
});
